...
/**
 * ChannelmanagerListChannelsWithAssociationsRequest Class Doc Comment
 *
 * @category Class
 * @package  GeminiCommerce\ChannelManager
 * @author   OpenAPI Generator team
 ...
 */
class ChannelmanagerListChannelsWithAssociationsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'channelmanagerListChannelsWithAssociationsRequest';
    ...
    */
     ...
     * Sets page_size
     *
     * @param int|null $page_size The number of items to return per page. If not specified, it will returns all items.
     *
     * @return self
     */
